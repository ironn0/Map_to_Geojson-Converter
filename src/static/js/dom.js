...
export const el = {
    ...
    imageEditPanel: $('image-edit-panel'),
    eraseModeErase: $('erase-mode-erase'),
    eraseModeRestore: $('erase-mode-restore'),
    eraserRadius: $('eraser-radius'),
    eraserRadiusValue: $('eraser-radius-value'),
    magicBrushToggle: $('magic-brush-toggle'),
    eraserStrokesCount: $('eraser-strokes-count'),
    applyEraserBtn: $('apply-eraser-btn'),
    cancelEraserBtn: $('cancel-eraser-btn'),
    ...
    // Feature properties
    featureDetailsDock: $('feature-details-dock'),
    featureDockClose: $('feature-dock-close'),
    featuresList: $('features-list'),
    featureCountLabel: $('feature-count-label'),
    featurePropertiesPanel: $('feature-properties-panel'),
    featureKindLabel: $('feature-kind-label'),
    featureNameInput: $('feature-name-input'),
    featureTypeInput: $('feature-type-input'),
    featureColorInput: $('feature-color-input'),
    featureDescriptionInput: $('feature-description-input'),
    featurePropsInput: $('feature-props-input'),
    featureAreaValue: $('feature-area-value'),
    featureVerticesValue: $('feature-vertices-value'),
    featureSaveBtn: $('feature-save-btn'),
    ...
    georefLockAspect: $('georef-lock-aspect'),
