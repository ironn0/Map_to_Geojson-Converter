 ...
 * @param {Function} renderPolygons - Callback per rendering
 * @param {Function} openDetailsPanel - Callback per dettagli feature
 */
export function handleDrawClick(e, renderPolygons, openDetailsPanel) {
    ...
    if (state.currentTool === 'draw-polygon' && state.isDrawing) {
        ...
        addPoint(x, y, renderPolygons, openDetailsPanel);
    }
}
 ...
 */
function addPoint(x, y, renderPolygons, openDetailsPanel) {
    ...
    if (openDetailsPanel) {
        setTimeout(() => openDetailsPanel(true), 100);
    }
 ...
 * @param {Function} openDetailsPanel - Callback per dettagli feature
 */
export function finishDrawing(renderPolygons, openDetailsPanel) {
